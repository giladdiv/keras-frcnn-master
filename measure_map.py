...
curr_path = os.getcwd()
test_path = os.path.join(curr_path,'VOCdevkit')
C.model_path = os.path.join(curr_path,'models/model_FC_trainval.hdf5')
...
for idx, img_data in enumerate(test_imgs):
	...
	for jk in range(R.shape[0] // C.num_rois + 1):
		...
		[P_cls, P_regr,_] = model_classifier_only.predict([F, ROIs])
